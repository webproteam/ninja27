...
if (!defined('CONTACT_EMAIL')) {
    ...
    define('NINJA_WEB_URL', env('NINJA_WEB_URL', 'https://www.ezinvoice.lu'));
    ...
    define('REFERRAL_PROGRAM_URL', env('REFERRAL_PROGRAM_URL', 'https://www.ezinvoice.lu/referral-program/'));
