...
@section('head')
  ...
  <link href="{{ asset('css/customize.css') }}?no_cache={{ NINJA_VERSION }}" rel="stylesheet" type="text/css"/>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              @else
                ...
                {!! link_to('https://www.ezinvoice.lu/?utm_source=powered_by', 'InvoiceNinja.com', ['target' => '_blank', 'title' => 'invoiceninja.com']) !!} -
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="panel-body">
                          ...
                          <p>{!! trans('texts.reseller_text', ['email' => HTML::mailto('contact@ezlux.lu')]) !!}</p>
                        </div>
